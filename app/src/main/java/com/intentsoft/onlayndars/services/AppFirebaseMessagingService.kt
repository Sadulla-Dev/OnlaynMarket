package com.intentsoft.onlayndars.services
...
import com.intentsoft.onlayndars.BuildConfig
import com.intentsoft.onlayndars.MainActivity
    ...
    fun showMessage(title: String, body: String, id: Long = System.currentTimeMillis()){
        ...
        val builder =
            NotificationCompat.Builder(this, channelId)
                ...
                .setLargeIcon(BitmapFactory.decodeResource(applicationContext.resources, R.drawable.image1))
